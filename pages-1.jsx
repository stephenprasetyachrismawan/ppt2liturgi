...
const runGeminiParsing = async ({ fileRaw, apiKey, rules, addLog, setSlides, setStep }) => {
  ...
  if (isPdf) {
    ...
    addLog({ t: ts(), k: "info", tag: "AI", body: `Mengirim ${slideTexts.length} halaman PDF ke Gemini 2.0 Flash-Lite…` });
    prompt = `${systemPrompt}
...
Output hanya JSON array:`;
    ...
    addLog({ t: ts(), k: "info", tag: "AI", body: `Mengirim ${slideTexts.length} slide ke Gemini 2.0 Flash-Lite…` });
    prompt = `${systemPrompt}
            ...
            <>
              ...
              <div className="section" style={{ background: "var(--green-soft-2)", borderColor: "#bbf7d0" }}>
                <div className="row gap-3" style={{ marginBottom: 10 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 14 }}>Google Gemini 2.0 Flash-Lite — {t("Gratis", "Free")}</div>
        ...
        <div>
          <div className={"drop " + (over ? "over" : "")}
            ...
            <div style={{ display: "inline-flex", gap: 6, marginTop: 18 }}>
              ...
              <span className="chip green dot">Gemini 2.0 Flash-Lite</span>
            </div>
          </div>
    ...
    <div className="page">
      <div className="page-header">
        <div>
          ...
          <div className="h-sub">
            {isRealMode
              ? t("JSZip (PPTX) atau PDF.js (PDF) mengekstrak teks di browser; Gemini 2.0 Flash-Lite mengklasifikasi ke 8 kategori liturgi.", "JSZip (PPTX) or PDF.js (PDF) extracts text in browser; Gemini 2.0 Flash-Lite classifies into 8 liturgy categories.")
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 24 }}>
        ...
        <div>
          <div className="row" style={{ marginBottom: 8, justifyContent: "space-between" }}>
            ...
            <span className="chip">{isRealMode ? "Gemini 2.0 Flash-Lite · free tier" : t("Demo · simulasi", "Demo · simulated")}</span>
          </div>
          <div className="log">
            {displayLog.map((l, i) => (
              <div key={i}>
